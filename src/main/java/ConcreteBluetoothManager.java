...
class ConcreteBluetoothManager implements BluetoothManager {
    ...
    public ConcreteBluetoothManager() throws Exception {
//        try {
...
//        }
    ...
    @Override
    public synchronized boolean openDevice(String name) throws Exception {
        return openDevice(name, () -> {});
    }

    @Override
    public synchronized boolean openDevice(String name, Runnable loadingCallback) throws Exception {
        isOpen = false;
        if (isSetup()) {
